...
<body class="bg-soft-navy">
  ...
  <script>
    ...
    const I18N_AR = {
      ...
      "prog.screen_title": "ماذا نفحص؟",
      "prog.screen1_t": "الخبرة والمهارات",
      "prog.screen1_d": "رعاية الأطفال، التنظيف، الغسيل، الطهي",
      "prog.screen2_t": "الخلفية والمراجع",
      "prog.screen2_d": "سجل العمل ومراجع قابلة للتواصل",
      "prog.screen3_t": "الصحة واللياقة",
      "prog.screen3_d": "الجاهزية للعمل والمتطلبات الطبية",
      "prog.screen4_t": "الوثائق",
      "prog.screen4_d": "هويات سارية، تصاريح، جاهزية للسفر",
      "prog.note": "يخضع الإيفاد للوثائق والتحقق من صاحب العمل والأنظمة المعمول بها في الدولة.",

      "sectors.badge": "البحرين",
      "sectors.title": "القطاعات التي نخدمها",
      "sectors.subtitle": "نربط أصحاب العمل في البحرين بكفاءات فلبينية في وظائف أساسية.",
      "sectors.hsw_t": "العمل المنزلي",
      "sectors.hsw_d": "مربيات، عاملات منزل، طهاة، مساعدين لرعاية المسنين",
      "sectors.hosp_t": "الضيافة",
      "sectors.hosp_d": "طاقم المطابخ، مقدمو الطعام، تنظيف الغرف، باريستا",
      "sectors.fac_t": "المرافق والتنظيف",
      "sectors.fac_d": "عمّال نظافة، فراشون، مساعدين للصيانة",
      "sectors.retail_t": "البيع بالتجزئة والخدمات",
      "sectors.retail_d": "مساعدو مبيعات، أمناء صندوق، منسقو مخزون",
      "sectors.health_t": "الرعاية الصحية (مساندة)",
      "sectors.health_d": "مقدمو رعاية، مساعدين، أدوار غير سريرية",
      "sectors.logi_t": "الدعم اللوجستي",
      "sectors.logi_d": "مساعدون، عمال تغليف، دعم أساسي للمستودعات",

      "process.badge": "الإجراءات",
      "process.title": "كيف تتم عملية التوظيف",
      "process.subtitle": "آلية شفافة ومنظمة ومتوافقة مع البحرين من الطلب حتى الإيفاد.",
      "process.s1_t": "1) طلب التوظيف",
      "process.s1_d": "تفاصيل الدور، العدد المطلوب، النطاق، الراتب، المزايا، الجدول الزمني",
      "process.s2_t": "2) الاستقطاب والفرز",
      "process.s2_d": "الخبرة، المراجع، الخلفية، اختبار المهارات",
      "process.s3_t": "3) المقابلات",
      "process.s3_d": "مقابلات العميل (عن بعد/حضوري)، قوائم مختصرة، تغذية راجعة",
      "process.s4_t": "4) التوثيق",
      ...
      "faq.e.q2": "ما وثائق صاحب العمل المطلوبة؟",
      "faq.e.a2": "عادةً: تعريف للمنشأة أو الأسرة، تفاصيل العقد، ووصف الدور. نقدّم قائمة متطلبات مخصصة للبحرين.",
      "faq.e.q3": "كيف يتم مواءمة المرشحين؟",
      "faq.e.a3": "حسب ملاءمة الدور والخبرة والمراجع وأداء المقابلة. نعرض قائمة مختصرة وننسّق مقابلاتكم.",
      "faq.a.q1": "ما الوثائق التي يعدّها المتقدمون؟",
      "faq.a.a1": "هويات حكومية، سيرة ذاتية، مراجع، تصاريح، فحص الجاهزية للعمل، ومتطلبات أخرى. نقدّم قائمة إرشادية وتحديثات.",
      "faq.a.q2": "هل توجد رسوم على العمال؟",
      "faq.a.a2": "نتّبع ممارسات توظيف أخلاقية ونوضح التكاليف المشروعة. لا رسوم غير قانونية.",
      "faq.a.q3": "هل يمكنني التقديم دون خبرة خارجية؟",
      "faq.a.a3": "نعم. نقيم مهاراتك وقابليتك للتعلّم. تفيد الخبرة المحلية والمراجع الواضحة في طلبك.",
      ...
      "contact.subtitle": "زر مكتبنا أو تواصل معنا عبر التفاصيل التالية",
      "contact.office_info": "معلومات المكتب",
      "contact.address_label": "العنوان",
      "contact.address": "وحدة 1، إدين تاون هومز<br>2001 شارع إدين زاوية شارع بيدرو جيل، سانا آنا<br>مانيلا، 1009 برانغاي 866، مدينة مانيلا<br>NCR، المنطقة السادسة",
      "contact.phone_label": "الهاتف",
      "contact.email_label": "البريد الإلكتروني",
      "contact.hours_label": "ساعات العمل",
      "contact.hours": "من الإثنين إلى السبت، 8:00 ص إلى 5:00 م",
      "contact.directions": "الحصول على الاتجاهات",
      "contact.back_top": "العودة للأعلى",

      "final.cta": "وظّف عمالة فلبينية ماهرة ومُفرزة بعناية للعمل في البحرين.",
      "final.btn": "وظّف الآن!"
    };
