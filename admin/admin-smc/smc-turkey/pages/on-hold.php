<?php
// FILE: admin/admin-smc/smc-turkey/pages/on-hold.php (SMC - Turkey)
// Purpose: SMC-scoped "On Hold Applicants" list with revert modal (BU-safe)
...
/**
 * Load list (BU-scoped; exclude blacklisted & soft-deleted)
 */
$applicants = [];
...
function getFullNameSafe($first, $middle, $last, $suffix) { return getFullName($first, $middle, $last, $suffix); }
...
<style>
  ...
  /* Modal polish */
  .revert-modal .modal-header { border-bottom: none; padding-bottom: 0; }
  ...
  .revert-modal .counter { font-size: .8rem; color: #64748b; }
                ...
                <div class="actions-inline dd-modern">
                  ...
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="changeStatusBtn-<?php echo $id; ?>">
                      ...
                      <li>
                        <!-- Optional blacklist page (ensure you have SMC version if needed) -->
...
<div class="modal fade revert-modal" id="revertModal" tabindex="-1"
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
    <!-- ACTION: point to your SMC revert handler; you can create pages/revert-onhold.php (SMC) -->
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.querySelectorAll('.js-open-revert').forEach(function(trigger) {
    trigger.addEventListener('click', function(e) {
      ...
      // Clear selects & description each time
      reasonSelect.value = '';
      descTA.value = '';
      updateCounter();
    });
