<?php
/**
 * SMC Admin (Turkey) Header
 * Path: admin/admin-smc/smc-turkey/includes/header.php
 */

declare(strict_types=1);

/** Resolve shared admin includes (admin/includes/*.php) */
$ADMIN_ROOT = dirname(__DIR__, 3); // -> /admin
...
if (!$canSeeSMC) {
    http_response_code(403);
    exit('Forbidden: SMC access required.');
}
...
$collapseApplicantsId = 'smcTurkeyApplicantsMenu';
?>
<!DOCTYPE html>
...
<head>
    ...
    <title><?php echo h($pageTitle ?? 'Dashboard'); ?> - <?php echo h(APP_NAME); ?> (SMC)</title>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="bookingBell"
                            ...
                            <?php foreach ($recentBookings as $booking): ?>
                                ...
                                $viewLink = '../../../pages/view_onprocess.php?id=' . $appId;
                                ?>
