...
(607, 12, 'Login', 'User logged in successfully', '::1', '2026-03-04 12:19:38'),
(608, 12, 'Update Applicant Status', 'Updated status for china Trial → approved', '::1', '2026-03-04 12:21:37'),
(609, 12, 'Update Applicant Status', 'Updated status for china Trial → pending (CSNK)', '::1', '2026-03-04 12:21:40'),
(610, 12, 'Update Applicant Status', 'Updated status for Ryzza Mae B. Diaz → approved', '::1', '2026-03-04 12:38:01'),
(611, 12, 'Update Applicant Status', 'Updated status for Ryzza Mae B. Diaz → pending (CSNK)', '::1', '2026-03-04 12:38:04'),
(612, 12, 'Update Applicant Status', 'Updated status for Ryzza Mae B. Diaz → on_process', '::1', '2026-03-04 12:39:48'),
(613, 12, 'Update Applicant Status (with report)', 'Updated status for Ryzza Mae B. Diaz → approved; Reason: Interview rescheduled: asd', '::1', '2026-03-04 12:39:55'),
(614, 12, 'Update Applicant Status', 'Updated status for Ryzza Mae B. Diaz → pending (CSNK)', '::1', '2026-03-04 12:40:06'),
(615, 12, 'Update Applicant Status', 'Updated status for Ryzza Mae B. Diaz → on_process', '::1', '2026-03-04 12:58:17'),
(616, 12, 'Update Applicant Status (with report)', 'Updated status for Ryzza Mae B. Diaz → approved; Reason: Passed interview / assessment: goods', '::1', '2026-03-04 12:58:26'),
(617, 12, 'Update Applicant Status', 'Updated status for Ryzza Mae B. Diaz → pending (CSNK)', '::1', '2026-03-04 12:58:35'),
(618, 12, 'Update Applicant Status', 'Updated status for Rowena Liza Cruz Mariano → approved', '::1', '2026-03-04 13:22:46'),
(619, 12, 'Update Applicant Status', 'Updated status for Rowena Liza Cruz Mariano → pending (CSNK)', '::1', '2026-03-04 13:22:52'),
(620, 12, 'Update Applicant Status', 'Updated status for Shiela May Basco Cortez → approved', '::1', '2026-03-04 13:36:11'),
(621, 12, 'Update Applicant Status', 'Updated status for Shiela May Basco Cortez → pending (CSNK)', '::1', '2026-03-04 13:36:17'),
(622, 12, 'Update Applicant Status', 'Updated status for Lorna Fe Bagtas Malabanan → on_process (SMC)', '::1', '2026-03-04 13:42:53'),
(623, 12, 'Update Applicant Status', 'Updated status for Lorna Fe Bagtas Malabanan → pending (SMC)', '::1', '2026-03-04 13:43:21'),
(624, 12, 'Update Applicant Status', 'Updated status for Denise Grace Angeles Mendiola → pending (SMC)', '::1', '2026-03-04 13:45:13'),
(625, 12, 'Update Applicant Status', 'Updated status for Lea Catherine Fernandez Rivera → pending (SMC)', '::1', '2026-03-04 13:45:14'),
(626, 12, 'Update Applicant Status', 'Updated status for Lorna Fe Bagtas Malabanan → pending (SMC)', '::1', '2026-03-04 13:45:16'),
(627, 12, 'Update Applicant Status', 'Updated status for Charmaine Rose Dimapilis Jimenez → pending (SMC)', '::1', '2026-03-04 13:45:17'),
(628, 12, 'Logout', 'User logged out', '::1', '2026-03-04 13:51:14'),
(629, 20, 'Login', 'User logged in successfully', '::1', '2026-03-04 13:51:20'),
