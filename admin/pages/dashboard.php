...
/* ---------------------- Client Bookings (Confirmed Only) ---------------------- */
$clientBookings = [];
...
if ($conn instanceof mysqli) {
  ...
  $bookingSql .= " ORDER BY cb.appointment_date DESC, cb.appointment_time DESC";
...
<!-- ===================== Client Bookings (Confirmed Only) ===================== -->
<div class="mt-4 glass-card" style="border-left: 4px solid #0d9488;">
  <div class="px-5 py-4 d-flex justify-content-between align-items-center">
    <div>
      <h5 class="mb-0 fw-semibold">
        <i class="bi bi-calendar-check me-2" style="color: #0d9488;"></i>Client Bookings
      </h5>
      <small class="text-muted">Confirmed bookings with applicants and contract terms.</small>
    </div>
    <div class="d-flex align-items-center gap-3">
      <span class="badge bg-teal-subtle text-teal px-3 py-2" style="background-color: #ccfbf1; color: #0d9488;">
        <i class="bi bi-people me-1"></i><?php echo count($clientBookings); ?> Bookings
      </span>
    </div>
  </div>
        ...
        <table class="table table-hover align-middle mb-0">
          <thead>
            <tr>
              ...
              <th style="width: 15%;">Contract Term</th>
              <th style="width: 15%;">Business Unit</th>
              <th style="width: 15%;">Booked Date</th>
            </tr>
          </thead>
          <tbody>
            <?php foreach ($clientBookings as $booking): ?>
              ...
              <tr>
                ...
                <td>
                  <div class="small">
                    <?php echo safe($clientContact); ?>
                  </div>
                </td>
                <td>
                  <span class="badge bg-info-subtle text-info" style="background-color: #cffafe; color: #0891b2;">
                    <i class="bi bi-calendar-event me-1"></i>
                    <?php echo safe($contractTerm); ?>
                  </span>
                </td>
                <td>
