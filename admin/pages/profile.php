...
function validateStrongPassword(string $pwd): ?string
{
  ...
  if (preg_match('/(.)\1{3,}/', $pwd))
    return 'New password must not contain repeated characters (e.g., "aaaa").';
  return null;
}
      ...
      <div class="card-body text-center p-4">
        ...
        <div class="position-relative d-inline-block mb-3">
          <div class="rounded-circle overflow-hidden border"
            style="width:140px;height:140px;border-color:#f1f1f1;background:#f7f7f7;">
            <?php if ($avatarUrl): ?>
              <img src="<?php echo $avatarUrl; ?>" alt="Avatar"
                style="width:100%;height:100%;object-fit:cover;display:block;">
            <?php else: ?>
              <div class="w-100 h-100 d-flex align-items-center justify-content-center bg-light"
                style="font-size:3rem;color:#991b1b;">
        ...
        <form method="POST" enctype="multipart/form-data" id="profileForm">
          <div class="mb-3">
            ...
            <div id="avatarDropzone"
              class="dropzone rounded-3 border border-2 d-flex align-items-center justify-content-center p-3"
              style="background:#fafafa; border-style:dashed; cursor:pointer;"
              aria-label="Drag & drop your image here or click to choose">
              <div class="text-center">
                <div class="mx-auto rounded-circle overflow-hidden mb-2"
                  style="width:96px;height:96px;background:#f3f4f6;border:1px solid #eee;">
                  <img id="avatarPreview" src="<?php echo $avatarUrl ?: ''; ?>" alt="Preview"
                    style="width:100%;height:100%;object-fit:cover;<?php echo $avatarUrl ? '' : 'display:none;'; ?>">
                </div>
          ...
          <?php if ($isSuperAdmin): ?>
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="username" required
                value="<?php echo htmlspecialchars($currentUserData['username']); ?>">
            </div>
          <?php else: ?>
            <div class="mb-3">
              <label class="form-label">Username</label>
              <div class="input-group">
                <input type="text" class="form-control readonly-locked px-3 py-2 rounded-start-2"
                  value="<?php echo htmlspecialchars($currentUserData['username']); ?>" readonly tabindex="-1"
                  aria-readonly="true">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="full_name" required
              value="<?php echo htmlspecialchars($currentUserData['full_name']); ?>">
          </div>
        ...
        <form method="POST" id="passwordForm" novalidate>
          ...
          <div class="mb-3">
            ...
            <input type="password" class="form-control" name="new_password" id="newPwd" required
              ...
              placeholder="Min 10 chars, uppercase, lowercase, number, special">
            <div class="progress mt-2" style="height:8px;">
              <div id="pwdBar" class="progress-bar" role="progressbar" style="width:0%"></div>
            </div>
            <small class="text-muted">Must be at least 10 characters, and include uppercase, lowercase, number, and
              special character. Avoid repeating the same character 4+ times.</small>
          </div>

          <div class="mb-3">
            <label class="form-label">Confirm New Password <span class="text-danger">*</span></label>
            <input type="password" class="form-control" name="confirm_password" id="newPwd2" required
              autocomplete="new-password" minlength="10">
