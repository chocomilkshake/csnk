...
function renderWorkHistoryListHtml(?string $json): string
{
    ...
    foreach ($arr as $row) {
        ...
        $top = [];
        if ($company !== '')
            $top[] = '<span class="fw-semibold">' . htmlspecialchars($company, ENT_QUOTES, 'UTF-8') . '</span>';
        if ($role !== '')
    ...
    <div class="col-12 col-lg-4">
        <div class="card">
            <div class="card-body text-center">
                <?php if ($pictureUrl): ?>
                    <img src="<?php echo htmlspecialchars($pictureUrl, ENT_QUOTES, 'UTF-8'); ?>" alt="Profile"
                ...
                <div class="text-start mt-3 quick-meta">
                    <div class="item mb-2">
                        ...
                        <span
                            class="value"><?php echo $primaryPhone !== '' ? htmlspecialchars($primaryPhone, ENT_QUOTES, 'UTF-8') : 'N/A'; ?></span>
                    </div>
                    <div class="item mb-2">
                        <span class="small-label">Phone (Alternate)</span>
                        <span
                            class="value"><?php echo htmlspecialchars($alternatePhoneDisplay, ENT_QUOTES, 'UTF-8'); ?></span>
                    </div>
                    <div class="item mb-2">
                        <span class="small-label">Email</span>
                        <span
                            class="value"><?php echo htmlspecialchars($applicantData['email'] ?? 'N/A', ENT_QUOTES, 'UTF-8'); ?></span>
                    </div>
                    <div class="item mb-2">
        ...
        <div class="card">
                ...
                <ul class="nav nav-tabs card-header-tabs" id="applicantTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="tab-overview" data-bs-toggle="tab"
                            data-bs-target="#panel-overview" type="button" role="tab" aria-controls="panel-overview"
                            aria-selected="true">
                            <i class="bi bi-person-lines-fill me-1"></i> Overview
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="tab-education" data-bs-toggle="tab"
                            data-bs-target="#panel-education" type="button" role="tab" aria-controls="panel-education"
                            aria-selected="false">
                            <i class="bi bi-mortarboard me-1"></i> Education
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="tab-work" data-bs-toggle="tab" data-bs-target="#panel-work"
                            type="button" role="tab" aria-controls="panel-work" aria-selected="false">
                            <i class="bi bi-briefcase me-1"></i> Work
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="tab-docs" data-bs-toggle="tab" data-bs-target="#panel-docs"
                            type="button" role="tab" aria-controls="panel-docs" aria-selected="false">
                            <i class="bi bi-folder2-open me-1"></i> Documents
                        </button>
                    </li>
                    <?php if ($hasVideo): ?>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="tab-video" data-bs-toggle="tab" data-bs-target="#panel-video"
                                type="button" role="tab" aria-controls="panel-video" aria-selected="false">
            ...
            <div class="card-body">
                <div class="tab-content" id="applicantTabsContent">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <div class="fw-semibold">
                                    <?php echo htmlspecialchars($applicantData['address'], ENT_QUOTES, 'UTF-8'); ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="fw-semibold">
                                    <?php echo !empty($applicantData['employment_type']) ? htmlspecialchars($applicantData['employment_type'], ENT_QUOTES, 'UTF-8') : 'N/A'; ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                    ...
                    <!-- Education -->
                    <div class="tab-pane fade" id="panel-education" role="tabpanel" aria-labelledby="tab-education"
                        tabindex="0">
                    ...
                    <!-- Video -->
                    <?php if ($hasVideo): ?>
                        <div class="tab-pane fade" id="panel-video" role="tabpanel" aria-labelledby="tab-video"
                            tabindex="0">
                            ...
                            <video controls preload="metadata" style="width:100%; max-height:500px; background:#000;">
                                <source
                                    src="<?php echo htmlspecialchars(getFileUrl($applicantData['video_url']), ENT_QUOTES, 'UTF-8'); ?>"
                                    type="video/mp4">
