...
<div class="mb-3 d-flex justify-content-end">
  <form method="get" action="reports.php" class="w-100" style="max-width: 420px;">
    <div class="input-group">
      <input type="text" name="q" class="form-control" placeholder="Search approved, notes or admin..."
        ...
        <?php else: ?>
          <?php foreach ($rows as $r): ?>
            ...
            <tr>
              ...
              <td><?php echo htmlspecialchars($latestAt !== '' ? formatDateTime($latestAt) : '—', ENT_QUOTES, 'UTF-8'); ?>
              </td>
              <td class="actions-cell">
                <button class="btn btn-sm btn-primary write-report" data-id="<?php echo $id; ?>"
                ...
                <button class="btn btn-sm btn-outline-secondary view-history" data-id="<?php echo $id; ?>"
                  data-name="<?php echo htmlspecialchars($name, ENT_QUOTES, 'UTF-8'); ?>" <?php echo $reportCount === 0 ? 'disabled' : ''; ?>>
