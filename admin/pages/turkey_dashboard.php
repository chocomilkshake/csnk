...
<div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mb-4">
  ...
  <div class="stat-card">
    <div class="p-5">
      ...
      <div class="mt-4">
        <span class="stat_chip"><span class="w-2 h-2 rounded-full" style="background:#f3d98b"></span> Awaiting review</span>
      </div>
    </div>
  </div>
  ...
  <div class="stat-card">
    <div class="p-5">
      ...
      <div class="mt-4">
        <span class="stat_chip"><span class="w-2 h-2 rounded-full" style="background:#f3d98b"></span> Actively handled</span>
      </div>
    </div>
  </div>
  ...
  <div class="stat-card">
    <div class="p-5">
      ...
      <div class="mt-4">
        <span class="stat_chip"><span class="w-2 h-2 rounded-full" style="background:#f3d98b"></span> Soft removed</span>
      </div>
    </div>
  </div>
</div>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    <?php if (!empty($app['picture'])): ?>
                      <img src="<?php echo safe(getFileUrl($app['picture'])); ?>" alt="Profile"
